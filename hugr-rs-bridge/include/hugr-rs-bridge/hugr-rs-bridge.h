...
mlir::FailureOr<hugr_unique_ptr<Hugr>> parse_hugr_json(mlir::Location loc, llvm::StringRef str);
mlir::FailureOr<hugr_unique_ptr<Hugr>> parse_hugr_rmp(mlir::Location loc, llvm::ArrayRef<uint8_t>);
...
mlir::LogicalResult hugr_to_mlir(mlir::MLIRContext*, Hugr const&, mlir::Block*);
