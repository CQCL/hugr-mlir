...
pub fn hugr_to_mlir_type<'c>(
    ...
    match type_.as_type_enum() {
        ...
        &TypeEnum::Tuple(ref row) => Ok(melior::ir::r#type::TupleType::new(
            &ctx,
            collect_type_row::<Vec<_>>(ctx, &row)?.as_slice(),
        )
        .into()),
        &TypeEnum::Prim(ref p) => match p {
            &PrimType::Extension(ref custom_type) => Ok(crate::mlir::hugr::OpaqueType::new(
            ...
            .into()),
            &PrimType::Alias(ref alias_decl) => Ok(mlir::hugr::AliasRefType::new(
            ...
            .into()),
            &PrimType::Function(ref function_type) => {
