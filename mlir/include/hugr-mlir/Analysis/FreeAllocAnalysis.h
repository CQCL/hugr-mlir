...
struct FreeAllocDenseAnalysis : mlir::dataflow::DenseForwardDataFlowAnalysis<FreeAllocAnalysisState> {
    using  DenseForwardDataFlowAnalysis::DenseForwardDataFlowAnalysis;
    using LatticeT = FreeAllocAnalysisState;
    void setToEntryState(LatticeT *lattice) override;
    void visitOperation(mlir::Operation *op, const LatticeT &before,
