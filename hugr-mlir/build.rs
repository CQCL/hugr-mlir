...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let bindings = bindgen::builder()
        ...
        .header("../mlir/include/hugr-mlir-c/Conversion.h")
        .header("../mlir/include/hugr-mlir-c/Opt.h")
        .allowlist_file(".*mlir/include/hugr-mlir-c/.*\\.h|.*/hugr-mlir/.*/Passes\\.capi\\.h\\.inc")
    ...
    println!("cargo:rerun-if-changed=../mlir/include/hugr-mlir-c/Conversion.h");
    println!("cargo:rerun-if-changed=../mlir/include/hugr-mlir-c/Opt.h");
